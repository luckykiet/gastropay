...
const PUBLIC_APP_URL = process.env.BASE_URL || 'http://localhost:3000';
const PROXY_URL = process.env.PROXY_URL;
const APP_NAME = process.env.APP_NAME || 'Gastro Pay';
...
const config = {
  ...
  API_URL:
    DEV_MODE
      ...
      : removeSlashFromUrl(PUBLIC_APP_URL) + SERVERLESS_PATH,
  BASE_URL: DEV_MODE ? LOCALHOST + ':' + APP_PORT : removeSlashFromUrl(PUBLIC_APP_URL),
  IMAGE_BASE_URL:
    DEV_MODE
      ? LOCALHOST + ':' + APP_PORT + '/images'
      : removeSlashFromUrl(PUBLIC_APP_URL) + '/images',
  PROXY_URL: PROXY_URL,
  LANGUAGES: {
    CS: 'cs',
    EN: 'en',
  },
  JWT_SECRET: process.env.JWT_SECRET || '@ThIS iS Sup3rb s3creT!',
